...
public class Gallery {
	...
	public void runTest(String loginurl ,  Logger logger) throws Exception {
		...
		logger.info("Inside Gallery Page", "PASS");
		...
		webDriver.findElement(By.xpath("//*[@href='/gallery']")).click();
		Thread.sleep(5000);			
		...
		eyes.check(Target.window().fully().withName("Gallery"));			
		webDriver.findElement(By.xpath("//*[@class='lightgallery-media']")).click();
		Thread.sleep(5000);
		eyes.check(Target.window().fully().withName("Gallery Lightbox"));
