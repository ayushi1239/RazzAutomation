...
public class Logger {
  ...
  public String getTime(){
	...
	{   
	    ...
	    htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") +"/Reports/LinkCheckAndContactUs_Result/"+"_"+getTime()+"_LinkCheck&ContactUs.html");
		...
		test = extent.createTest("LINK CHECK TEST and Contact Us Form", "Akara Automation TestCase");
